...
namespace RcRenueva\Simulacion\Client\Api;
...
use RcRenueva\Simulacion\Client\HeaderSelector;
use RcRenueva\Simulacion\Client\ObjectSerializer;

class ReporteDeCrditoRenuevaApi
{
    ...
    {
        $returnType = '\RcRenueva\Simulacion\Client\Model\Respuesta';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\RcRenueva\Simulacion\Client\Model\Respuesta',
                ...
                case 400:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\RcRenueva\Simulacion\Client\Model\Errores',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
